    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                if (data.success) {
                    // Filter for Women's category by default or based on selection
                    setProducts(data.products.filter((p: Product) => p.category.toLowerCase().includes("women") || p.category === "Women" || !p.category));
                }
            } catch (error) {
